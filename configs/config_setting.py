...
class setting_config:
    ...
    test_weights = '/data/fengxiao/UltraLight-VM-UNet/results/UltraLight_VM_UNet_NC4K_Friday_25_July_2025_13h_06m_37s/checkpoints/best-epoch220-loss0.7303.pth'

    datasets = 'Fish_Dataset'  # ISIC2017, ISIC2018, PH2, NC4K, AD
    if datasets == 'ISIC2017':
        data_path= '/data/fengxiao/UltraLight-VM-UNet/data/dataset_isic17/'
    elif datasets == 'ISIC2018':
        data_path = '/data/fengxiao/UltraLight-VM-UNet/data/ISIC2018/'
    elif datasets == 'PH2':
        data_path = ''
    elif datasets == 'NC4K':
        data_path = '/data/fengxiao/UltraLight-VM-UNet/data/NC4K/'
    elif datasets == 'AD':
        data_path = '/data/fengxiao/UltraLight-VM-UNet/data/AD/'
    elif datasets == 'Fish_Dataset':
        data_path = '/data/fengxiao/UltraLight-VM-UNet/data/Fish_Dataset/'
    elif datasets == 'DeepCrack':
        data_path = '/data/fengxiao/UltraLight-VM-UNet/data/DeepCrack/'
    else:

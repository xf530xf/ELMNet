...
class ELMNet(nn.Module):
    ...
    def __init__(self, num_classes=1, input_channels=3, c_list=[8,16,24,32,48,64],
        ...
        self.DBlock = DBlock(c=48)

        self.LCA1 =  LCA(dim=8,num_heads=4)

        self.LCA2=  LCA(dim=16,num_heads=4)

        self.LCA3 =  LCA(dim=24,num_heads=4)

        self.LCA4 =  LCA(dim=32,num_heads=4)
    ...
    def forward(self, x):
        ...
        t5=self.DBlock(t5) # b, c4, H/32, W/32
        ...
        # print(out5.shape, t5.shape)   torch.Size([8, 48, 8, 8]) torch.Size([8, 48, 8, 8])

...
def main(config):
    ...
    resume_model = os.path.join('/data/fengxiao/UltraLight-VM-UNet/results/UltraLight_VM_UNet_ISIC2017_Thursday_24_July_2025_23h_06m_25s/checkpoints/best-epoch221-loss0.2225.pth')
